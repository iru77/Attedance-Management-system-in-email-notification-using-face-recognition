...
class Face_Recognition:
    ...
    def check_absentees(self):
        ...
        hod_email= 'ansarimdirfan298@gmail.com'
    ...
    def mark_attendance_exit(self, id, roll_no ,name, email):
        ...
        if result:
            ...
            cursor.execute("INSERT INTO exitattendance (std_id, std_name, std_email, std_roll_no, std_date, std_exit_tiime,  std_attendance) VALUES (%s, %s, %s, %s, %s, %s, %s)", (id, name, email,roll_no,date, current_time,"Right Time"))
            conn.commit()  
            self.exit_count += 1  
        conn.close()
    ...
    def send_email(self, recipient, subject, body):
        ...
        smtp_port = 465
        email_from = 'mdiansari2000@gmail.com'
        email_password = 'suzd dmqg dpkv bzip'  # Replace with your App Password
