...
class Attendance:
    ...
    def __init__(self, root):
        ...
        delete_btn.grid(row=0, column=1, padx=6, pady=10, sticky=W)
        ...
        # reset_btn.grid(row=0, column=, padx=6, pady=10, sticky=W)
        ...
        import_btn.grid(row=0, column=2, padx=6, pady=10, sticky=W)
        ...
        export_btn.grid(row=0, column=3, padx=6, pady=10, sticky=W)
        ...
        search_entry.grid(row=0,column=5,padx=5,pady=10,sticky=W)
    ...
    def search_data(self):
        ...
        my_cursor.execute("SELECT * FROM stdattendance WHERE std_name='" + str(self.var_search.get()) + "'")
        rows_std = my_cursor.fetchall()
        # Search in exitattendance table
        my_cursor.execute("SELECT * FROM exitattendance WHERE std_name='" + str(self.var_search.get()) + "'")
