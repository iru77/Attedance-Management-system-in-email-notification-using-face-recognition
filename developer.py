...
# This part is image labels setting start 
        ...
        det_b1_1 = Button(bg_img,text="NILESH KUMAR \n Branch: CSE",cursor="hand2",font=("times new roman",15,"bold"),bg="white",fg="navyblue")
        det_b1_1.place(x=330,y=380,width=200,height=70)

         # student  button 3
        att_img_btn=Image.open(r"Images_GUI\utt.jpeg")
        ...
        att_b1_1 = Button(bg_img,text="UTTAM RAJWAR \n Branch: CSE",cursor="hand2",font=("times new roman",15,"bold"),bg="white",fg="navyblue")
        att_b1_1.place(x=560,y=380,width=200,height=70)

         # student  button 4
        hlp_img_bt=Image.open(r"Images_GUI\v.jpeg")
        ...
        hlp_b1_1 = Button(bg_img,text="ABHIJEET KUMAR \n Branch: CSE",cursor="hand2",font=("times new roman",15,"bold"),bg="white",fg="navyblue")
